	...
	// Default shader sources
	{
		std::vector<ShaderSource> shaderSources
		{
			ShaderSource{ shader::LAMBERTIAN,
				fullShaderPath( "model_view_projection.vert" ),
				fullShaderPath( "lambertian.frag" ) },
			ShaderSource{ shader::LAMBERTIAN_TRANSPARENT,
				fullShaderPath( "model_view_projection.vert" ),
				fullShaderPath( "lambertian.frag" ) },
			ShaderSource{ shader::LIGHTS,
				fullShaderPath( "model_view_projection.vert" ),
				fullShaderPath( "single_color.frag" ) },
			ShaderSource{ shader::SINGLE_COLOR_BORDER,
				fullShaderPath( "model_view_projection_scaled.vert" ),
				fullShaderPath( "single_color.frag" ) },
			ShaderSource{ shader::SPRITE_DEFAULT,
				fullShaderPath( "model_view_projection.vert" ),
				fullShaderPath( "sprite_default.frag" ) },
			ShaderSource{ shader::LAMBERTIAN_INSTANCED,
				fullShaderPath( "model_view_projection_instanced.vert" ),
				fullShaderPath( "sprite_default.frag" ) },
			ShaderSource{ shader::FULL_SCREEN,
				fullShaderPath( "full_screen.vert" ),
				fullShaderPath( "full_screen.frag" ) },
			ShaderSource{ shader::FULL_SCREEN_COLOR_INVERTED,
				fullShaderPath( "full_screen.vert" ),
				fullShaderPath( "full_screen_inverted_color.frag" ) },
			ShaderSource{ shader::FULL_SCREEN_BLUR_VERTICAL,
				fullShaderPath( "full_screen.vert" ),
				fullShaderPath( "full_screen_blur_vertical.frag" ) },
			ShaderSource{ shader::FULL_SCREEN_BLUR_HORIZONTAL,
				fullShaderPath( "full_screen.vert" ),
				fullShaderPath( "full_screen_blur_horizontal.frag" ) },
			ShaderSource{ shader::FULL_SCREEN_PIXELATED,
				fullShaderPath( "full_screen.vert" ),
				fullShaderPath( "full_screen_pixelated.frag" ) },
			ShaderSource{ shader::FULL_SCREEN_CHROME_ABERRATION,
				fullShaderPath( "full_screen.vert" ),
				fullShaderPath( "full_screen_chrome_aberrated.frag" ) },
			ShaderSource{ shader::FULL_SCREEN_COLOR_CORRECTION,
				fullShaderPath( "full_screen.vert" ),
				fullShaderPath( "full_screen_color_corrected.frag" ) },
			ShaderSource{ shader::SKYBOX,
				fullShaderPath( "skybox.vert" ),
				fullShaderPath( "skybox.frag" ) },
				// TODO add NULL_SHADER - pink shader
			ShaderSource{ shader::NULL_SHADER,
				fullShaderPath( "model_view_projection.vert" ),
				fullShaderPath( "error.frag" ) },
		};
