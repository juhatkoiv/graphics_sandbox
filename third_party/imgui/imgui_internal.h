...
public:
    ImGuiWindow(ImGuiContext* _context, const char* name);
    ~ImGuiWindow();
...
namespace ImGui
{
    ...
    IMGUI_API ImGuiID       AddContextHook(ImGuiContext* _context, const ImGuiContextHook* hook);
    IMGUI_API void          RemoveContextHook(ImGuiContext* _context, ImGuiID hook_to_remove);
    IMGUI_API void          CallContextHooks(ImGuiContext* _context, ImGuiContextHookType type);
...
//#endif
    ...
    IMGUI_API void          DebugNodeInputTextState(ImGuiInputTextState* inputState);
